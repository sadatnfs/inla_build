...
sudo make lib-install && sudo make bin && sudo mv inla/rinla/R/obsolete/* inla/rinla/R/
sudo make package && sudo R --vanilla CMD INSTALL /usr/lib/R/library/tmp/RINLA/INLA_*.tgz
